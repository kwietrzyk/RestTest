...
public class GitHubTest {
    ...
    public void testGetRepos() {
        ...
        response.then().spec(respSpec).statusCode(200).body("", hasSize(expectedSize));
    ...
    public void testDeleteRepo() {
        ...
        //String repoToDeleteName = "evenNewerRepo";  // zostawiam tu jakby ktos sobie chcial tworzyc i usuwac inne
        String repoToDeleteName = NEW_NAME;
        given(reqSpec)
                .header("X-GitHub-Api-Version", "2022-11-28")
                .delete("repos/kwietrzyk/" + repoToDeleteName)
                .then().spec(respSpec).statusCode(either(is(200)).or(is(204)));  // dostajemy tu 204
    }
}
